	...
	setTimeout(function () {
		if(data instanceof Array) {
			...
			if(newCardAmount > oldCardAmount) {
				// Make new cards
			} else if(newCardAmount < oldCardAmount) {
				// Delete old cards
			} else {
				// Card amount is equal
			...
			// Data is probably of type Object and need to do something else like tell user they need to pass in an array instead
		}
	}, 500);
}
