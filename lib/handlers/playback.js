...
exports.startPlayback = function(response,platform, mediaID, url, file, subtitleUrl, subtitleTitle, type) {
    ...
    , hasSub = false
    , transcodePath = "./public/data/"+type+"/"+outputName+".mp4"
    , outputPath = "/data/"+type+"/"+outputName+".mp4"
    , outputPathWebFriendly = "/data/"+type+"/"+file;
                ...
                if(data.transcodingstatus === 'pending' || data.transcodingstatus === undefined){
                    ...
                    if(fs.existsSync(url)){
                        if(filetype === 'mp4'){
                            ...
                            fs.copySync(url, "./public" + outputPathWebFriendly);
