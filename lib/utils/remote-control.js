...
exports.remoteControl = function() {
    ...
    io.sockets.on('connection', function (socket) {
        ...
        //TODO: switch actions to use rooms.
        socket.on("addAction", function(data) {
            socket.broadcast.emit("addAction", data);
        });
        socket.on("removeAction", function(data) {
            socket.broadcast.emit("removeAction", data);
        });
        socket.on("doAction", function (data) {
            socket.broadcast.emit("doAction", data);
        });
        socket.on("getActions", function(data) {
           socket.broadcast.emit("getActions", data);
        });
