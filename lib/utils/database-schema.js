	...
	validate: {
		onlyOneID: function () {
			if (((this.TrackId === null)
			   + (this.MovieId === null)
			   + (this.EpisodeId === null)) !== 1) {
				throw new "ProgressionMarker must have only one media";
			}
		}
	}
});

ProgressionMarker.hasOne(Track);
ProgressionMarker.hasOne(Movie);
ProgressionMarker.hasOne(Episode);
