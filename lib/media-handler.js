...
var MediaLoader = function(list_object_type, playback_object_type, metadataProcessor, dir) {
...
MediaLoader.prototype.load = function(findOptions, callback, dontFetchMetadata) {
  var self = this;
...
MediaLoader.prototype.fetchMetadata = function(callback) {
  var self = this;
...
MediaLoader.prototype.savePlaybackProgress = function (id, progression, callback) {
  var baseMarker = {};
...
MediaLoader.prototype.editMetadata = function (id, newData, callback) {
...
MediaLoader.prototype.updateMetadata = function (id, newData, callback) {
  var self = this;
  this.list_entity.find(id).success(function(object) {
     object.set(newData);
...
MediaLoader.prototype.playFile = function (res, platform, id) {
  var self = this;
...
MediaLoader.prototype.stopTranscoding = function(callback) {
