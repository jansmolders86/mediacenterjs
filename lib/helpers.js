module.exports = {
	...
	*/
	getLocalFiles: function (req, res, dir, writePath, getDir, callback) {
		var fs = require('fs')	
		var	status = null
				...
				files.forEach(function(file){
					...
					if (stats.isDirectory(file)) {
						...
						if(getDir === true){
							...
							if (!file.match(/\.(m3u|bmp|jpg|png|ini|gif|sub|srt|txt|doc|docx|pdf|nfo|cbr|xml|idx|exe|rar|zip|7z|diz|par|torrent|par2|ppt|info|md|db)/)){
