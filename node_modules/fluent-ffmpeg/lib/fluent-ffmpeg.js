...
function FfmpegCommand(args) {
  ...
  FfmpegCommand.prototype.bufferSize = function(sizeString) {
    this.options.bufsize = sizeString;
    return this;
  };  
  FfmpegCommand.prototype.chunkSize = function(sizeString) {
    this.options.chunk.size = sizeString;
    return this;
  };   
